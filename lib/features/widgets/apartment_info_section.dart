...
class ApartmentInfoSection extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              contractType == '매매' ? Colors.blue : Colors.grey,
                ...
                const SizedBox(height: 16),
                _buildPriceField('매매가 (선택)', '금액입력', '만원'),
                const SizedBox(height: 8),
                _buildPriceField('관리비 (선택)', '금액입력', '만원'),
                const SizedBox(height: 16),
                const Text('면적 (선택)'),
                const SizedBox(height: 8),
                Row(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        await box.put(newApartment.storageKey, newApartment);
  ...
  Widget _buildPriceField(String label, String hint, String suffix) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label),
